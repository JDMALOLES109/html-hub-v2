...
const Team = () => {
    ...
    return (
        <>
            <div className='grid grid-cols-1 bg-black pt-24' id={'Team'}>
            ...
            <div className='bg-black sm:h-auto h-auto xl:h-screen lg:h-screen md:screen grid xl:flex lg:flex md:flex sm:grid-rows-1 grid-rows-1 gap-4 p-16 justify-center items-center'>
                <div>
                <div className='text-center' data-aos='fade-up'>
                <div className='flex justify-center'>
