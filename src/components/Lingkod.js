...
const Lingkod = () => {
    ...
    return (
        <>
            <div className='bg-white xl:h-screen lg:hscreen md:h-screen sm:h-auto h-auto grid grid-cols-1'>
                <div className='p-10'>
                    <h1 className='text-3xl' data-aos='fade-up'>Ano ang maipaglilingkod namin sayo/sainyo</h1>
