...
<div className='xl:flex lg:flex justify-between items-center'>
    <div className='xl:text-left lg:text-left md:text-center sm:text-center text-center'>
        <h1 className='headerUno'><span className='text-yellow-500'>J</span>ava<span className='text-yellow-500'>S</span>cript</h1>
        <p className='parag pb-4'>Ang utak ng website</p>
    </div>
    <div>
    <Tab.Group>
